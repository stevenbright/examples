...
privileged aspect Profile_Roo_Entity {
    ...
    public static long Profile.countProfiles() {
        return ((Number) entityManager().createQuery("select count(o) from Profile o").getSingleResult()).longValue();
    }
    ...
    public static List<Profile> Profile.findProfileEntries(int firstResult, int maxResults) {
        return entityManager().createQuery("select o from Profile o").setFirstResult(firstResult).setMaxResults(maxResults).getResultList();
    }
