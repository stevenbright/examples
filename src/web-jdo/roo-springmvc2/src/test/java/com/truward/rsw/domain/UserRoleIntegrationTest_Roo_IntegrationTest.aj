...
import com.truward.rsw.domain.UserRoleDataOnDemand;
...
privileged aspect UserRoleIntegrationTest_Roo_IntegrationTest {
    ...
    public void UserRoleIntegrationTest.testCountUserRoles() {
        ...
        long count = com.truward.rsw.domain.UserRole.countUserRoles();
    ...
    public void UserRoleIntegrationTest.testFindUserRole() {
        com.truward.rsw.domain.UserRole obj = dod.getRandomUserRole();
        ...
        obj = com.truward.rsw.domain.UserRole.findUserRole(id);
    ...
    public void UserRoleIntegrationTest.testFindAllUserRoles() {
        ...
        java.util.List<com.truward.rsw.domain.UserRole> result = com.truward.rsw.domain.UserRole.findAllUserRoles();
    ...
    public void UserRoleIntegrationTest.testFindUserRoleEntries() {
        ...
        java.util.List<com.truward.rsw.domain.UserRole> result = com.truward.rsw.domain.UserRole.findUserRoleEntries(0, (int) count);
    ...
    public void UserRoleIntegrationTest.testMerge() {
        ...
        boolean modified =  dod.modifyUserRole(obj);
        java.lang.Integer currentVersion = obj.getVersion();
        com.truward.rsw.domain.UserRole merged = (com.truward.rsw.domain.UserRole) obj.merge();
        obj.flush();
    ...
    public void UserRoleIntegrationTest.testPersist() {
        org.junit.Assert.assertNotNull("Data on demand for 'UserRole' failed to initialize correctly", dod.getRandomUserRole());
        com.truward.rsw.domain.UserRole obj = dod.getNewTransientUserRole(Integer.MAX_VALUE);
    ...
    public void UserRoleIntegrationTest.testRemove() {
        ...
        obj.remove();
        obj.flush();
        org.junit.Assert.assertNull("Failed to remove 'UserRole' with identifier '" + id + "'", com.truward.rsw.domain.UserRole.findUserRole(id));
    }
